            ...
            <div class="row">
              ...
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6">
                <div class="courses  webd w-100">
                  ...
                  <a href="{{route('frontend.course_detail')}}">ICT Foundation</a>
              ...
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6">
                <div class="courses ict w-100 h-50">
                    ...
                    <a href="{{route('frontend.course_detail')}}"> Photoshop Beginner Class</a>
                </div>
                
              </div>
              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-6">
                <div class="courses advanceexcel w-100 h-50">
                  <a href="{{route('frontend.course_detail')}}">Advance Excel</a>
                </div>
              </div>
            </div> 
          </div>
